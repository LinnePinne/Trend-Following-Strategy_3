...
EXIT_CONFIRM_BARS = 10 # testa 2, 3, 5
...
def run_backtest_for_market(market_name: str, csv_path: str):
    ...
    exit_breach_count = 0  # <-- NY: räknar antal bars i rad där ema_fast <= ema_medium
    ...
    for i in range(1, len(df) - 1):
        ...
        if in_position:
            ...
            # Delayed EMA recross-exit: kräver EXIT_CONFIRM_BARS i rad under/likamed
